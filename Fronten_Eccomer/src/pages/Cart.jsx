            ...
            <div className='bg-white w-full max-w-xl p-6 rounded-2xl relative overflow-y-auto max-h-[90vh]'>
                ...
                <ul className='divide-y divide-gray-300'>
                    {
                        cartData.map((itam,index) => (
                            <li key={index} className='flex items-center gap-5 py-4'>
                                <img src={`/uploads/${itam.productImage}`} alt="" className='w-14 h-10 rounded-sm object-cover border border-gray-300' />
                                <div className='flex-1'>
                                    <h3 className='font-semibold text-gray-700'>{itam.productName}</h3>
                                </div>
                ...
                <div className='mt-4 text-right'>
                    <p className='text-lg font-semibold text-gray-800'>
                        Total Quantity : 
                        <span className='text-gray-700 font-bold'> {cartAllTotal.TotalQuantity}</span>
                    </p>
                    <p className='text-lg font-semibold text-gray-800'>
                        Total Price : 
                        <span className='text-green-700 font-bold'> ₹ {cartAllTotal.TotalPrice}</span>
                    </p>
